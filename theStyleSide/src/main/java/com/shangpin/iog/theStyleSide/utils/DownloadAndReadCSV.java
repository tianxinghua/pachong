package com.shangpin.iog.theStyleSide.utils;
...
public class DownloadAndReadCSV {
     ...
     * @throws Exception
     */
    public static <T> List<T> readLocalCSV(Class<T> clazz,String sep,List<String> realPaths) throws Exception {
        
    	//List<String> realPaths=new ArrayList<String>();
    	//realPaths.add(path+".csv");
...
//    		cr = new CsvReader(new FileReader("F:/forzieri1.csv"));
  ...
  public static void main(String[] args) {
        try {
        	System.out.println("下载中".substring(1));
