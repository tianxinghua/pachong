...
public class StringUtil {
     ...
     *get tony Category Name by id
     */
    public static String getCategoryNameByID(List<Map<String,String>> catList, Map<String,String> categoryMap){
    	try{
...
//                 categoryId =catList.get(0).get("$id");
    ...
    public static String getCategoryNameByID(Object tempCategoryMap, Map<String,String> categoryMap){
    	try{
    		 List<String> categoryIdList = new ArrayList<>();
//                 categoryId =catList.get(0).get("$id");
                     categoryIdList.add(tempCategoryMap.toString());
            String categoryName ="";
            for(String categoryId:categoryIdList){
                categoryName = categoryName+ categoryMap.get(categoryId)+"-";
            }
