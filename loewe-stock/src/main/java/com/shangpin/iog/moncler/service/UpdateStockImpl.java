...
public class UpdateStockImpl extends FetchStockImpl {
    ...
    public void fetchItlyProductStock(){
        ...
        System.out.println("============更新loewe库存数据库开始 "+startDateTime+"=========================");
        logger.info("==============更新loewe库存数据库开始 "+startDateTime+"=========================");
        ...
        String csvFilePath = filePath +"loewe-qty-"+ yesterdayDateStr+".csv";
        try {
        ...
        logger.info("===================更新loewe库存数据库结束 "+endtDateTime+"=========================");
        System.out.println("=================更新loewe库存数据库结束 "+endtDateTime+"=========================");
