...
/**
 * <p>tLectureStockParMagSurCde complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="tLectureStockParMagSurCde"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="sMagInternet" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "tLectureStockParMagSurCde", propOrder = {
    "sArticle",
    "bcData",
    "sUser",
    "sMdp",
...
public class TLectureStockParMagSurCde {
     ...
     *     
     */
    public void setSMagInternet(String value) {
        this.sMagInternet = value;
    }
