...
@Component("suitnegoziOrderService")
public class SuitnegoziOrderServiceImpl implements IOrderService {
    ...
    @PostConstruct
    public void init(){
    	cancelUrl = supplierProperties.getSuitnegoziParam().getCancelUrl();
    	queryOrderUrl = supplierProperties.getSuitnegoziParam().getQueryOrderUrl();
    	setOrderUrl = supplierProperties.getSuitnegoziParam().getSetOrderUrl();
    	dBContext = supplierProperties.getSuitnegoziParam().getDBContext();
    	key = supplierProperties.getSuitnegoziParam().getKey();
    }
