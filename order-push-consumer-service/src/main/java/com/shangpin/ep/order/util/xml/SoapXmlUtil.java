package com.shangpin.ep.order.util.xml;
...
public class SoapXmlUtil {
	 ...
	 */
	public static String getSoapXml(String serviceUrl ,String sopAction,String contentType,String soapRequestData) throws Exception {
		...
		try {
            ...
            if(returnCode == 200){
            	...
            	throw new Exception("状态码:"+returnCode);
            }
