package com.shangpin.ep.order.util.httpclient;
...
public class HttpUtil45 {
	 ...
	 */
	public static String postAuth(String url, Map<String,String> param, OutTimeConfig outTimeConf, String userName, String password) throws ServiceException{
		String result=null;
		try {
	 ...
	 * @see OutTimeConfig 超时设置
	 */
	public static String postNTAuth(String url, Map<String,String> param, OutTimeConfig outTimeConf, String userName, String password) throws ServiceException{
		String result=null;
		try {
	 ...
	 * @see OutTimeConfig 超时设置
	 */
	public static String postAuth(String url, Map<String,String> param, Map<String,String> headerMap, OutTimeConfig outTimeConf, String userName, String password) throws ServiceException{
		String result=null;
		try {
			HttpClientContext localContext = getAuthContext(url,userName,password);
	 ...
	 * @see OutTimeConfig 超时设置
	 */
	public static String post(String url, OutTimeConfig outTimeConf) throws ServiceException{
	 ...
	 * @see OutTimeConfig 超时设置
	 */
	public static String post(String url, Map<String,String> param, OutTimeConfig outTimeConf) throws ServiceException{
	 ...
	 * @see OutTimeConfig 超时设置
	 */
	public static String post(String url, Map<String,String> param, Map<String,String> headerMap, OutTimeConfig outTimeConf) throws ServiceException{
	...
	private static void  setHeader(Map<String,String> headMap, HttpUriRequest request ){
		if(null!=headMap&&headMap.size()>0){
			...
			for(Iterator<Entry<String,String>> itor = headMap.entrySet().iterator(); itor.hasNext();){
	...
	private static String post(String url, Map<String,String> param, OutTimeConfig outTimeConf
			, HttpClientContext localContext ) throws ServiceException{
		HttpPost post=new HttpPost(url);
		if(param!=null){
			Iterable<? extends NameValuePair> nvs = map2NameValuePair(param);
	...
	private static String getPostResult(String url, OutTimeConfig outTimeConf, HttpClientContext localContext, HttpPost post) throws ServiceException{
		String result=null;
		CloseableHttpResponse resp=null;
		try {
			localContext.setRequestConfig(defaultRequestConfig(outTimeConf));
