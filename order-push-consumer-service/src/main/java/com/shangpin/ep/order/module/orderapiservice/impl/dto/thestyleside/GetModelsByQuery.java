...
@XmlRootElement(name = "GetModelsByQuery")
public class GetModelsByQuery {
    ...
    @XmlElementRef(name = "view", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> view;
     ...
     *     
     */
    public JAXBElement<String> getView() {
        return view;
    }
     ...
     *     
     */
    public void setView(JAXBElement<String> value) {
        this.view = value;
    }
