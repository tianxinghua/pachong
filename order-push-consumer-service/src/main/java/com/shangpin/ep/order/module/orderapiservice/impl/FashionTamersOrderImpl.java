...
public class FashionTamersOrderImpl  implements IOrderService {
    ...
    @PostConstruct
    public void init(){
    	cancelUrl = supplierProperties.getFashionTamersConf().getCancelUrl();
    	placeUrl =  supplierProperties.getFashionTamersConf().getPlaceUrl();
    	appKey =  supplierProperties.getFashionTamersConf().getOpenApiKey();
    	appSe =  supplierProperties.getFashionTamersConf().getOpenApiSecret();
    }
	/**
	 * 锁库存
	 */
...
//    @HystrixCommand(fallbackMethod = "handleException")
	...
	public static void main(String[] args) {
		FashionTamersOrderImpl ompl = new FashionTamersOrderImpl();
