...
//			return   lindeSearchStock.getSearchStock(productDTO.getSupplierSkuNo());
//		}else if("2016102701837".equals(productDTO.getSupplierId())){
//			return   montiSearchStock.getSearchStock(productDTO.getSupplierSkuNo());
...
//			return   papiniSearchStock.getSearchStock(productDTO.getSupplierSkuNo());
//		}else if("2016102701840".equals(productDTO.getSupplierId())){
//			return   pozzileiSearchService.getSearchStock(productDTO.getSupplierSkuNo());
//		}else if("2016102701841".equals(productDTO.getSupplierId())){
//			return   sanremoSearchService.getSearchStock(productDTO.getSupplierSkuNo());
//		}else if("2016102701842".equals(productDTO.getSupplierId())){
//			return   spinnakerSearchService.getSearchStock(productDTO.getSupplierSkuNo());
//		}else if("2016102701843".equals(productDTO.getSupplierId())){
//			return   studioSearchService.getSearchStock(productDTO.getSupplierSkuNo());
//		}else if("2016102701844".equals(productDTO.getSupplierId())){
//			return   velaSearchService.getSearchStock(productDTO.getSupplierSkuNo());
//		}else if("2016102701845".equals(productDTO.getSupplierId())){
//			return   coltortiSearchService.getSearchStock(productDTO.getSupplierSkuNo());
...
//			return   pozzileiArteSearchService.getSearchStock(productDTO.getSupplierSkuNo());
//		}else if("2016101401948".equals(productDTO.getSupplierId())){
//			return   pozzileiFortSearchService.getSearchStock(productDTO.getSupplierSkuNo());
//		}
