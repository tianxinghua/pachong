...
@Component("divoServiceImpl")
public class DivoServiceImpl implements IOrderService {
     ...
     * @throws Exception
     */
    public String divoPost(String url, Map<String,String> param, OutTimeConfig outTimeConf, String userName, String password,OrderDTO order) throws Exception{
