...
@Component("papiniOrderService")
public class PapiniOrderService implements IOrderService {
...
public static void main(String[] args) {
	 ...
	 * @throws Exception
	 */	
	private String papiniPushOrder(String url, OrderDTO orderDTO,Map<String, String> map)  throws Exception{
