...
@Component("sanremoOrderService")
public class SanremoOrderService implements IOrderService {
    ...
    @PostConstruct
    public void init(){
    	cancelUrl = supplierProperties.getSanremoParam().getCancelUrl();
    	queryOrderUrl = supplierProperties.getSanremoParam().getQueryOrderUrl();
    	setOrderUrl = supplierProperties.getSanremoParam().getSetOrderUrl();
    	dBContext = supplierProperties.getSanremoParam().getDBContext();
    	key = supplierProperties.getSanremoParam().getKey();
    }
    ...
    @Override
   	 ...
   	 * @throws Exception
   	 */	
   	private String sanremoPushOrder(String url, OrderDTO orderDTO,Map<String, String> map)  throws Exception{
   	...
   	private void createOrder( OrderDTO orderDTO) {
   		...
   		try {
   			 ...
   			 map.put("key", key);
   			 map.put("sellPrice", "0");
   			 rtnData =sanremoPushOrder(setOrderUrl,orderDTO, map);
