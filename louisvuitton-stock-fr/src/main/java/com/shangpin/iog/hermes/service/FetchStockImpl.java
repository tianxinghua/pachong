...
public class FetchStockImpl  {
    ...
    public Map<String,String> getProductSkuPrivateInfo(String skuNo) throws Exception{
        ...
        /**
         ...
         https://fr.louisvuitton.cn/ajax/product.jsp?storeLang=zhs-cn&pageType=product&id=
         */
        String qtyUrl = "https://fr.louisvuitton.cn/ajax/product.jsp?storeLang=zhs-cn&pageType=product&id="+skuNo;
    ...
    public Map<String,String> getProductQty(String skuNo) throws Exception{
         ...
         *  https://secure.louisvuitton.com/ajaxsecure/getStockLevel.jsp?storeLang=zhs-cn&pageType=product&skuIdList=
         */
        String qtyUrl = "https://secure.louisvuitton.com/ajaxsecure/getStockLevel.jsp?storeLang=zhs-cn&pageType=product&skuIdList="+skuNo;
