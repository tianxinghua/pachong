...
import com.shangpin.iog.${supplierName}.util.${supplierName}Util;
...
public class FetchProduct {
	...
	public void fetchProductAndSave() {
		...
		${supplierName}Util kixUtil = new ${supplierName}Util();
		List<Product> allProducts = ${supplierName}Util.getAllProducts();
