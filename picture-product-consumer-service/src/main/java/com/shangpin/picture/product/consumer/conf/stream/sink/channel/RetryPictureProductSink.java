...
public interface RetryPictureProductSink {
	...
	public String BRAND_PICTURE = "retryBrandPictureProduct";
	/**
	 ...
	 * @return 供应商商品通用图片数据流通道组件
	 */
	@Input(value = RetryPictureProductSink.BRAND_PICTURE)
    public SubscribableChannel retryBrandPictureProduct();
}
