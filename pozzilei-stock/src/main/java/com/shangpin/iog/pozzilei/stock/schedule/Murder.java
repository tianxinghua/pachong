package com.shangpin.iog.pozzilei.stock.schedule;
...
import com.shangpin.iog.pozzilei.stock.PozzileiStockImp;
@Component
public class Murder extends TimerTask{
	...
	private PozzileiStockImp stockImp;
	public void setStockImp(PozzileiStockImp stockImp) {
