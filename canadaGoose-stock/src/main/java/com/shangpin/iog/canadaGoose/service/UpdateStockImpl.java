...
import com.shangpin.iog.canadaGoose.XinghuaClickTest;
import com.shangpin.iog.canadaGoose.dto.ApiResponseBody;
import com.shangpin.iog.canadaGoose.dto.SpSkuNoDTO;
import com.shangpin.iog.canadaGoose.dto.ZhiCaiSkuHttpDTO;
import com.shangpin.iog.canadaGoose.dto.ZhiCaiSkuStock;
...
public class UpdateStockImpl extends FetchStockImpl {
    ...
    public void fetchItlyProductStock(){
        ...
        System.out.println("============更新canadagoose库存数据库开始 "+startDateTime+"=========================");
        logger.info("==============更新canadagoose库存数据库开始 "+startDateTime+"=========================");
        ...
        String csvFilePath = filePath +"canadagoose-qty-"+ yesterdayDateStr+".csv";
        try {
        ...
        updateChannelLastTimeUrl(supplierId,"www.canadagoose.com");
        logger.info("===================更新canadagoose库存数据库结束 "+endtDateTime+"=========================");
        System.out.println("=================更新canadagoose库存数据库结束 "+endtDateTime+"=========================");
        /*if (emailFlag==false){
            logger.info("===================准备发送邮件 =========================");
