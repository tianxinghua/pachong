...
package com.shangpin.iog.EMonti.util;
...
public class MagentoServiceLocator extends org.apache.axis.client.Service implements MagentoService {
    ...
    public PortType getPort() throws javax.xml.rpc.ServiceException {
    ...
    public PortType getPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                BindingStub _stub = new BindingStub(new java.net.URL(Port_address), this);
                _stub.setPortName(getPortWSDDServiceName());
                return _stub;
            }
        }
