...
//	        font.setBoldweight(HSSFFont.BOLDWEIGHT_BOLD);  
	...
	public static void exportExcelColor(String title, String[] headers, String[] columns, List<Map<String, String>> result, OutputStream out) throws Exception{
...
//	        font.setBoldweight(HSSFFont.BOLDWEIGHT_BOLD);
     ...
     * @throws Exception 
     */  
    public static void exportExcel1(String title, String[] headers, String[] columns, List<HashMap<String, Object>> result, OutputStream out) throws Exception{  
        // 声明一个工作薄  
        HSSFWorkbook workbook = new HSSFWorkbook();  
        // 生成一个表格  
        HSSFSheet sheet = workbook.createSheet(title);  
