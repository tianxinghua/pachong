...
<script type="text/javascript">
	...
	function exportStockUpdateException(){
...
<div style="text-align: left; padding: 0px 20px 20px 20px;">
	<a href="javascript:window.open('stockUpdateException')" id="btn-save" icon="icon-search" class='easyui-linkbutton'>库存更新异常导出</a> 
	<a href="javascript:void(0)" onclick="clearText()" id="btn-cancel" icon="icon-cancel" class='easyui-linkbutton'>清空</a>
