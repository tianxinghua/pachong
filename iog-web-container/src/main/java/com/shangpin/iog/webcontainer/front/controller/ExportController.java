...
public class ExportController {
	...
	public void tempExport(HttpServletResponse response,String queryJson){
		BufferedInputStream in = null;
        BufferedOutputStream out = null;
        StringBuffer productBuffer =null;
		try {
	        ...
	        productBuffer =productService.tempExport(supplier, startDate, endDate, pageIndex, pageSize);
