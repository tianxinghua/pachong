...
public class FtpUtil {
	...
	public static <T> List<T> readLocalCSV(Class<T> clazz,List<String> contentList) throws Exception {
...
//		download();
		try {
			...
			readLocalCSV(Product.class,contentList);
		} catch (Exception e) {
