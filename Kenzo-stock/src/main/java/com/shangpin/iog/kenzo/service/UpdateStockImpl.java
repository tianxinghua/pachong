...
import com.shangpin.iog.kenzo.dto.ZhiCaiSkuHttpDTO;
import com.shangpin.iog.kenzo.dto.ApiResponseBody;
import com.shangpin.iog.kenzo.dto.SpSkuNoDTO;
import com.shangpin.iog.kenzo.dto.ZhiCaiSkuStock;
...
public class UpdateStockImpl extends FetchStockImpl {
    ...
    public void fetchItlyProductStock(){
        ...
        System.out.println("============更新kenzo库存数据库开始 "+startDateTime+"=========================");
        logger.info("==============更新kenzo库存数据库开始 "+startDateTime+"=========================");
        ...
        String csvFilePath = filePath +"sandro-qty-"+ yesterdayDateStr+".csv";
        try {
        ...
        logger.info("===================更新kenzo库存数据库结束 "+endtDateTime+"=========================");
        System.out.println("=================更新kenzo库存数据库结束 "+endtDateTime+"=========================");
    ...
    public static void main(String[] args) {
        ...
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
        String yesterdayDateStr = simpleDateFormat.format(yesterDate);
        String csvFilePath = filePath +"kenzo-qty-"+ yesterdayDateStr+".csv";
        try {
