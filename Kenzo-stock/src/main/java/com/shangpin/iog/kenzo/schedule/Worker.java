package com.shangpin.iog.kenzo.schedule;

import com.shangpin.iog.kenzo.service.FetchStockImpl;
...
public class Worker implements Runnable{
	...
	public void run() {
		try {
            ...
            System.out.println("MONCLER库存数据库开始 "+startDateTime);
