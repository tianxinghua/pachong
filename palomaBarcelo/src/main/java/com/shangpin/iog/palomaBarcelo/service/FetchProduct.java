package com.shangpin.iog.palomaBarcelo.service;
...
import com.shangpin.iog.palomaBarcelo.dao.Image;
import com.shangpin.iog.palomaBarcelo.dao.Item;
import com.shangpin.iog.palomaBarcelo.dao.Material;
import com.shangpin.iog.palomaBarcelo.dao.Result;
		...
		if(retList!=null){
			...
			for (Item item : retList) {
				...
				try {
					...
					sku.setMarketPrice(item.getBase_price());
