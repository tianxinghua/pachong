package com.shangpin.iog.otherstories.schedule;

import com.shangpin.iog.otherstories.service.FetchStockImpl;
...
public class Worker implements Runnable{
	...
	public void run() {
		try {
            ...
            System.out.println("otherstoris库存数据库开始 "+startDateTime);

			logger.info("更新otherstoris库存数据库开始 "+startDateTime);
			try {
