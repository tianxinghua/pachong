...
import com.shangpin.iog.otherstories.dto.SpSkuNoDTO;
import com.shangpin.iog.otherstories.dto.ApiResponseBody;
import com.shangpin.iog.otherstories.dto.ZhiCaiSkuHttpDTO;
import com.shangpin.iog.otherstories.dto.ZhiCaiSkuStock;
 ...
 *
 * 读取 otherstories 库存 csx 文件 推送库存数据
 *
 */
...
public class UpdateStockImpl extends FetchStockImpl {
    ...
    public void fetchItlyProductStock(){
        ...
        String csvFilePath = filePath +"otherstories-qty-"+ todayDateStr +".csv";
        ...
        logger.info("===================更新Other Stories库存数据库结束 "+endtDateTime+"=========================");
        System.out.println("=================更新Other Stories库存数据库结束 "+endtDateTime+"=========================");
    }
