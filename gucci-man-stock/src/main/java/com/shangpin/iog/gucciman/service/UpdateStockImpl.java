...
import com.shangpin.iog.gucciman.dto.ApiResponseBody;
import com.shangpin.iog.gucciman.dto.SpSkuNoDTO;
import com.shangpin.iog.gucciman.dto.ZhiCaiSkuHttpDTO;
import com.shangpin.iog.gucciman.dto.ZhiCaiSkuStock;
...
public class UpdateStockImpl extends FetchStockImpl {
    ...
    public void fetchItlyProductStock(){
        ...
        System.out.println("============更新GUCCI-MAN库存数据库开始 "+startDateTime+"=========================");
        logger.info("==============更新GUCCI-MAN库存数据库开始 "+startDateTime+"=========================");
        ...
        String csvFilePath = filePath +"gucci-man-qty-"+ yesterdayDateStr+".csv";
        try {
        ...
        logger.info("===================更新GUCCI-MAN库存数据库结束 "+endtDateTime+"=========================");
        System.out.println("=================更新GUCCI-MAN库存数据库结束 "+endtDateTime+"=========================");
