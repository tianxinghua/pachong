...
import com.shangpin.iog.sandro.dto.ApiResponseBody;
import com.shangpin.iog.sandro.dto.SpSkuNoDTO;
import com.shangpin.iog.sandro.dto.ZhiCaiSkuHttpDTO;
import com.shangpin.iog.sandro.dto.ZhiCaiSkuStock;
...
public class UpdateStockImpl extends FetchStockImpl {
    ...
    public void fetchItlyProductStock(){
        ...
        System.out.println("============更新Sandro库存数据库开始 "+startDateTime+"=========================");
        logger.info("==============更新Sandro库存数据库开始 "+startDateTime+"=========================");
        ...
        logger.info("===================更新Sandro库存数据库结束 "+endtDateTime+"=========================");
        System.out.println("=================更新Sandro库存数据库结束 "+endtDateTime+"=========================");
