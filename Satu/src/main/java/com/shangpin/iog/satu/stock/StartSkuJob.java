...
import com.shangpin.iog.satu.stock.service.FetchProduct;
import com.shangpin.iog.satu.stock.service.FrameFetchProduct;
...
public class StartSkuJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //拉取数据
        FetchProduct fetchProduct =(FetchProduct)factory.getBean("Stau");
