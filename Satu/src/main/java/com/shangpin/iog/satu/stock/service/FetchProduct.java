package com.shangpin.iog.satu.stock.service;
...
import com.shangpin.iog.satu.stock.dto.*;
    ...
    public void fetchProductAndSave() {
	    try{
	        ...
	        for(String database:databaseArray){
	            String season_json = HttpUtil45.get("http://net13server2.net/SatuApi/Myapi/Productslist/GetAllSeasonCode?DBContext="+database+"&key=KCAyafuX3A",outTimeConfig,null);
	            ...
	            for (Seasoncode obj : season_list.getSeasonCode()){
	                ...
	                while (true){
	                    ...
	                    producturl = "http://net13server2.net/SatuApi/MyApi/Productslist/GetProducts?DBContext="+database+"&CategoryId=&BrandId=&SeasonCode=[[seasoncode]]&StartIndex=[[startindex]]&EndIndex=[[endindex]]&key=KCAyafuX3A";
	                    String url = null;
	                    try {
	                        ...
	                        if (list != null && list.getProduct() != null) {
	                            ...
	                            for (Spu spu : list.getProduct()) {
	                                ...
	                                for (Sku sku : spu.getItems().getItem()) {
	                                    ...
	                                    priceUrl = "http://net13server2.net/SatuApi/MyApi/Productslist/GetPriceByItemID?DBContext="+database+"&ItemID="+itemID+"&key=KCAyafuX3A";
	                                    try {
