package com.shangpin.iog.balenciga.schedule;

import com.shangpin.iog.balenciga.service.FetchStockImpl;
...
public class Worker implements Runnable{
	...
	public void run() {
		try {
            ...
            System.out.println("balenciga库存数据库开始 "+startDateTime);

			logger.info("更新balenciga库存数据库开始 "+startDateTime);
			try {
