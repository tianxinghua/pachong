...
import com.shangpin.iog.balenciga.dto.SpSkuNoDTO;
import com.shangpin.iog.balenciga.dto.ApiResponseBody;
import com.shangpin.iog.balenciga.dto.ZhiCaiSkuHttpDTO;
import com.shangpin.iog.balenciga.dto.ZhiCaiSkuStock;
...
public class UpdateStockImpl extends FetchStockImpl {
    ...
    public void fetchItlyProductStock(){
        ...
        String csvFilePath = filePath +"balenciga-qty-"+ todayDateStr+"-2.csv";
        if(!new File(csvFilePath).exists()){
            csvFilePath = filePath +"balenciga-qty-"+ todayDateStr+"-1.csv";
            if(!new File(csvFilePath).exists()){
                csvFilePath = filePath +"balenciga-qty-"+ yesterdayDateStr+"-2.csv";
                if(!new File(csvFilePath).exists()){
                    csvFilePath = filePath +"balenciga-qty-"+ yesterdayDateStr+"-1.csv";
                }
            }
        }
