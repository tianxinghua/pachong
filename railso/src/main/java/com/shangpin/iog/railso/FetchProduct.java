...
public class FetchProduct {
	...
	public void fetchProductAndSave(String urlStr){
			...
			try {
	            ...
	            for (Item item : rss.getChannel().getItem()) {
	                ...
	                for(Object size :item.getSize()){
		                ...
		                sku.setProductSize(size.toString());
		              ...
		              //保存图片
		                if (item.getImageLinks() != null) {
		                	...
		                	item.getAdd_images().add(item.getImageLinks());
		                    for (Object imageUrl : item.getAdd_images()) {
		                        if (imageUrl != null && !"".equals(imageUrl)) {
		                            ProductPictureDTO dto = new ProductPictureDTO();
		                            dto.setPicUrl(imageUrl.toString());
