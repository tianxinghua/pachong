...
import com.shangpin.studio.data.mysql.conf.datasource.DataSourceProperties;
 ...
 */
@Configuration
@MapperScan(annotationClass = Mapper.class ,basePackages = {"com.shangpin.studio.data.mysql.mapper"})
@EnableConfigurationProperties(DataSourceProperties.class)
public class DataSourceConf {

	private static final String DATASOURCEID = "studio-data-mysql-service";
