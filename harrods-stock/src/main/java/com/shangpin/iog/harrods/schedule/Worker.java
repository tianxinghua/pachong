package com.shangpin.iog.harrods.schedule;

import com.shangpin.iog.harrods.service.FetchStockImpl;
...
public class Worker implements Runnable{
	...
	public void run() {
		try {
            ...
            System.out.println("HARRODS库存数据库开始 "+startDateTime);
