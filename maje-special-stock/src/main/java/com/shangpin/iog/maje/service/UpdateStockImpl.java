...
import com.shangpin.iog.maje.dto.ApiResponseBody;
import com.shangpin.iog.maje.dto.SpSkuNoDTO;
import com.shangpin.iog.maje.dto.ZhiCaiSkuHttpDTO;
import com.shangpin.iog.maje.dto.ZhiCaiSkuStock;
...
public class UpdateStockImpl extends FetchStockImpl {
    ...
    public void fetchItlyProductStock(){
        ...
        System.out.println("============更新maje库存数据库开始 "+startDateTime+"=========================");
        ...
        String csvFilePath = filePath +"maje-qty-"+ yesterdayDateStr+".csv";
        try {
        ...
        logger.info("===================更新maje库存数据库结束 "+endtDateTime+"=========================");
        System.out.println("=================更新maje库存数据库结束 "+endtDateTime+"=========================");
