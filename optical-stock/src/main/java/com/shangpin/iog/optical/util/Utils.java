package com.shangpin.iog.optical.util;
...
public class Utils {
	...
	public static List<List<String>>  getListProduct(String filepath) {
	...
	public static List<Element>  getList(String filepath) throws DocumentException{
