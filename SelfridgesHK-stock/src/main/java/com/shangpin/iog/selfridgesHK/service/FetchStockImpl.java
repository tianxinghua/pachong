package com.shangpin.iog.selfridgesHK.service;

import com.google.gson.JsonArray;
import com.google.gson.JsonObject;
import com.google.gson.JsonParser;
import com.shangpin.iog.selfridgesHK.dto.*;
...
public class FetchStockImpl {
    ...
    public void fetchItlyProductStock(){
        ...
        System.out.println("============拉取SelfridgesHK库存数据开始 "+startDateTime+"=========================");
        logger.info("==============拉取SelfridgesHK库存数据开始 "+startDateTime+"=========================");
        ...
        String temFilePath = filePath + "SelfridgesHK-qty-"+todayStr+".csv";
        String priceFilePath = filePath + "SelfridgesHK-price-"+todayStr+".csv";
        ...
        logger.info("=====需要更新SelfridgesHK spProduct Size:"+productDTOAllList.size());
        System.out.println("=====需要更新SelfridgesHK spProduct Size:"+productDTOAllList.size());
        //导出尚品库存数据
        ...
        logger.info("===================拉取SelfridgesHK库存数据结束 "+endtDateTime+"=========================");
        System.out.println("=================拉取SelfridgesHK库存数据结束 "+endtDateTime+"=========================");
...
//        }
    ...
    public static void main(String[] args) {
        ...
        productDTO.setProductUrl("http://www.selfridges.com/HK/zh/cat/suqqu-treatment-primer_396-3000994-18635/");
