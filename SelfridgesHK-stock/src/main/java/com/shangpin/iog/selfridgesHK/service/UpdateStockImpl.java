...
import com.shangpin.iog.selfridgesHK.dto.ApiResponseBody;
import com.shangpin.iog.selfridgesHK.dto.SpSkuNoDTO;
import com.shangpin.iog.selfridgesHK.dto.ZhiCaiSkuHttpDTO;
import com.shangpin.iog.selfridgesHK.dto.ZhiCaiSkuStock;
...
public class UpdateStockImpl extends FetchStockImpl {
    ...
    public void fetchItlyProductStock(){
        ...
        System.out.println("============更新SelfridgesHK库存数据库开始 "+startDateTime+"=========================");
        logger.info("==============更新SelfridgesHK库存数据库开始 "+startDateTime+"=========================");
        ...
        String csvFilePath = filePath +"SelfridgesHK-qty-"+ yesterdayDateStr+".csv";
        try {
        ...
        logger.info("===================更新SelfridgesHK库存数据库结束 "+endtDateTime+"=========================");
        System.out.println("=================更新SelfridgesHK库存数据库结束 "+endtDateTime+"=========================");
        /*if (emailFlag==false){
            logger.info("===================准备发送邮件 =========================");
