...
public class DownloadAndReadCSV {
     ...
     */
    public static String downloadHttp() throws MalformedURLException {
        int bytesum = 0;
        int byteread = 0;
    ...
    public static String downloadFtp() throws MalformedURLException {
        int bytesum = 0;
        int byteread = 0;
        ...
        try {
            ...
            try {
                inStream = FTPClientUtil.downFile("");
    ...
    public static JSONArray readLocalCSV() throws Exception {
    	...
    	String realPath=downloadHttp();
    	if(StringUtils.isBlank(realPath)){
            realPath=downloadFtp();
        }
