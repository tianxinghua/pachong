...
public class UpdateStockImpl extends FetchStockImpl {
    ...
    public void fetchItlyProductStock(){
        ...
        System.out.println("============更新poporcelain库存数据库开始 "+startDateTime+"=========================");
        logger.info("==============更新poporcelain库存数据库开始 "+startDateTime+"=========================");
      ...
      /*  long dayTime = 1000*3600*24l;
        ...
        String csvFilePath = filePath +"poporcelain-qty-" + todayDateStr + ".csv";
        try {
        ...
        logger.info("===================更新poporcelain库存数据库结束 "+endtDateTime+"=========================");
        System.out.println("=================更新poporcelain库存数据库结束 "+endtDateTime+"=========================");
