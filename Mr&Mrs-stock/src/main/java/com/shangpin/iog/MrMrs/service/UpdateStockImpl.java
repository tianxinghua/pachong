...
import com.shangpin.iog.MrMrs.dto.ApiResponseBody;
import com.shangpin.iog.MrMrs.dto.SpSkuNoDTO;
import com.shangpin.iog.MrMrs.dto.ZhiCaiSkuHttpDTO;
import com.shangpin.iog.MrMrs.dto.ZhiCaiSkuStock;
...
public class UpdateStockImpl extends FetchStockImpl {
    ...
    public void fetchItlyProductStock(){
        ...
        System.out.println("============更新MrMrs库存数据库开始 "+startDateTime+"=========================");
        ...
        String csvFilePath = filePath +"MrMrs-qty-"+ yesterdayDateStr+".csv";
        try {
        ...
        updateChannelLastTimeUrl(supplierId,"www.mmi.it");
        logger.info("===================更新MrMrs库存数据库结束 "+endtDateTime+"=========================");
        System.out.println("=================更新MrMrs库存数据库结束 "+endtDateTime+"=========================");
        /*if (emailFlag==false){
            logger.info("===================准备发送邮件 =========================");
