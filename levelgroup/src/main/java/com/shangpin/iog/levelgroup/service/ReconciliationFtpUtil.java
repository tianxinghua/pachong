...
public class ReconciliationFtpUtil {
    ...
    private static String HOST="ftp://ftp.thelevelgroup-ftp.com/TLG_GooglePLA_lncc_IT.txt",PORT="233",USER="googlepla@thelevelgroup-ftp.com",PASSWORD="tlg2014!",FILE_PATH="TLG_GooglePLA_lncc_IT.txt";
    ...
    public static void download(String remoteFilePath,String remoteFileName,String localFilePath,Boolean isFile){
        ...
        try
        {
            ...
            System.out.println("connected===="+ftp.connected());
            String[]  files = null;
