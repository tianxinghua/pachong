...
import com.shangpin.iog.maisonkitsune.dto.ApiResponseBody;
import com.shangpin.iog.maisonkitsune.dto.SpSkuNoDTO;
import com.shangpin.iog.maisonkitsune.dto.ZhiCaiSkuHttpDTO;
import com.shangpin.iog.maisonkitsune.dto.ZhiCaiSkuStock;
...
public class UpdateStockImpl extends FetchStockImpl {
    ...
    public void fetchItlyProductStock(){
        ...
        System.out.println("============更新maisonkitsune库存数据库开始 "+startDateTime+"=========================");
        logger.info("==============更新maisonkitsune库存数据库开始 "+startDateTime+"=========================");
        ...
        String csvFilePath = filePath +"maisonkitsune-qty-"+ yesterdayDateStr+".csv";
        try {
        ...
        logger.info("===================更新maisonkitsune库存数据库结束 "+endtDateTime+"=========================");
        System.out.println("=================更新maisonkitsune库存数据库结束 "+endtDateTime+"=========================");
