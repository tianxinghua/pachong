package com.shangpin.iog.maisonkitsune.schedule;

import com.shangpin.iog.maisonkitsune.service.FetchStockImpl;
...
public class Worker implements Runnable{
	...
	public void run() {
		try {
            ...
            System.out.println("maisonkitsune库存数据库开始 "+startDateTime);
