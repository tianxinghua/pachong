...
public class ColtortiProductService extends AbsSaveProduct{
	 ...
	 * @throws ServiceException
	 */
	public  List<ColtortiProduct> findProduct(String start,String end) throws ServiceException{
	 ...
	 * @throws ServiceException
	 */
	public  List<ColtortiProduct> findProductByProductId(String productId) throws ServiceException{
	 ...
	 * @throws ServiceException
	 */
	public  List<ColtortiProduct> findProductBySkuId(String recordId) throws ServiceException{
...
//					throw e;
	 ...
	 * @throws ServiceException
	 */
	public  List<ColtortiProduct> findProduct(int page,int size,String dateStart,
			String dateEnd,String productId,String recordId) throws ServiceException{
		Map<String,String> param=ColtortiUtil.getCommonParam(page,size);
			...
			if(scalars!=null && scalars.size()>0){
				...
				for (String sck : scks) {
					...
					try {
						...
						if(null!=prd.getSizeStockMap()&&prd.getSizeStockMap().containsKey(sck)){
							pt.setStock(prd.getSizeStockMap().get(sck));
						}else{
							pt.setStock(0);
						}
						...
						logger.error("拆分尺码 ，组成新SKU失败。"+e.getMessage());
						e.printStackTrace();
					}
				}
			}
...
//		findProduct(1,40,"152790AAV000001");
		...
		List<ColtortiProduct> ps=divideSku4Size(null);
