 ...
 */
public interface RetryPriceSource {

	public String SUPPLIER_PRICE = "supplierRetryPrice";
	
	/**
	 * @return 供应商商品价格数据流通道组件
	 */
	@Output(value = RetryPriceSource.SUPPLIER_PRICE)
    public MessageChannel supplierRetryPrice();
}
