...
public class SopSkuInventoryQueryDto extends Ice.ObjectImpl
{
    public SopSkuInventoryQueryDto()
    {
    }

    public SopSkuInventoryQueryDto(String SkuName, String SupplierSkuNo, String ProductModel, int PageIndex, int PageSize)
    {
    ...
    private static class __F implements Ice.ObjectFactory
    {
        public Ice.Object create(String type)
        {
            ...
            return new SopSkuInventoryQueryDto();
        }
    ...
    public static final long serialVersionUID = 318738460L;
}
