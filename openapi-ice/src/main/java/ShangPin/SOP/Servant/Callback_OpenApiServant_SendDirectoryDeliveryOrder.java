...
public abstract class Callback_OpenApiServant_SendDirectoryDeliveryOrder extends Ice.TwowayCallback
{
    ...
    public final void __completed(Ice.AsyncResult __result)
    {
        ...
        try
        {
            __ret = __proxy.end_SendDirectoryDeliveryOrder(__result);
        }
