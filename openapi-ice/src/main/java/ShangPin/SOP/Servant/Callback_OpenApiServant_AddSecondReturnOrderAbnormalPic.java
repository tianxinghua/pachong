...
public abstract class Callback_OpenApiServant_AddSecondReturnOrderAbnormalPic extends Ice.TwowayCallback
{
    ...
    public final void __completed(Ice.AsyncResult __result)
    {
        ...
        try
        {
            __ret = __proxy.end_AddSecondReturnOrderAbnormalPic(__result);
        }
