...
//									String goodsIds = HttpUtil45.get(url_getGoodsIdList, outTimeConf, paramMap, headMap, "", "");
...
//															if(data.getData().getColor().equals(dataC.getId())){
//																color = dataC.getName();
//																break;
//															}
//														}
...
//														spu.setCategoryId(dataCat.getCategoryID());														
//														spu.setCategoryName(dataCat.getName());
...
//														spu.setBrandId(brandDate.getID());														
//														spu.setBrandName(brandDate.getName());
