...
public class UpdateStockImpl extends FetchStockImpl {
    ...
    public void fetchItlyProductStock(){
        ...
        String csvFilePath = filePath +"mytheresa-qty-"+ yesterdayDateStr+".csv";
        try {
        ...
        logger.info("===================更新mytheresa库存数据库结束 "+endtDateTime+"=========================");
        System.out.println("=================更新mytheresa库存数据库结束 "+endtDateTime+"=========================");
