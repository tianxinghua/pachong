...
package com.shangpin.iog.EMonti.axisclient;

public class MagentoServiceLocator extends org.apache.axis.client.Service implements com.shangpin.iog.EMonti.axisclient.MagentoService {
    ...
    private java.lang.String Port_address = "http://www.wondersmall.com/index.php/api/soap/index/";
    ...
    public com.shangpin.iog.EMonti.axisclient.PortType getPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.shangpin.iog.EMonti.axisclient.PortType getPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.shangpin.iog.EMonti.axisclient.BindingStub _stub = new com.shangpin.iog.EMonti.axisclient.BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.shangpin.iog.EMonti.axisclient.PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.shangpin.iog.EMonti.axisclient.BindingStub _stub = new com.shangpin.iog.EMonti.axisclient.BindingStub(new java.net.URL(Port_address), this);
                _stub.setPortName(getPortWSDDServiceName());
                return _stub;
            }
        }
