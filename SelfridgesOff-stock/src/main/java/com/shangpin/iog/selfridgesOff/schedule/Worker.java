package com.shangpin.iog.selfridgesOff.schedule;

import com.shangpin.iog.selfridgesOff.service.FetchStockImpl;
...
public class Worker implements Runnable{
	...
	public void run() {
		try {
            ...
            System.out.println("SelfridgesOff库存数据库开始 "+startDateTime);
