package com.shangpin.iog.selfridgesOff.service;

import com.google.gson.JsonArray;
import com.google.gson.JsonObject;
import com.google.gson.JsonParser;
import com.shangpin.iog.selfridgesOff.dto.*;
...
public class FetchStockImpl {
    ...
    public void fetchItlyProductStock(){
        ...
        System.out.println("============拉取SelfridgesOff库存数据开始 "+startDateTime+"=========================");
        logger.info("==============拉取SelfridgesOff库存数据开始 "+startDateTime+"=========================");
        ...
        String temFilePath = filePath + "SelfridgesOff-qty-"+todayStr+".csv";
        String priceFilePath = filePath + "SelfridgesOff-price-"+todayStr+".csv";
        ...
        logger.info("=====需要更新SelfridgesOff spProduct Size:"+productDTOAllList.size());
        System.out.println("=====需要更新SelfridgesOff spProduct Size:"+productDTOAllList.size());
        //导出尚品库存数据
        ...
        logger.info("===================拉取SelfridgesOff库存数据结束 "+endtDateTime+"=========================");
        System.out.println("=================拉取SelfridgesOff库存数据结束 "+endtDateTime+"=========================");
    ...
    private static boolean solveProductQty(ProductDTO productDTO) {
        ...
        try {
            ...
            if (response.getStatus()==200) {
                ...
                String color= "";
                try {
                    color = productUrl.split("Attribute=")[1].replace("+","%20").replace("%2F","/");
...
//        }
    ...
    /*protected boolean getFileToEmail(){
        ...
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
        String yesterdayDateStr = simpleDateFormat.format(yesterDate);
        String fileName=bdl.getString("csvFilePath")+"SelfridgesOff-price-"+yesterdayDateStr+".csv";
        File file=new File(bdl.getString("csvFilePath")+"SelfridgesOff-price-"+yesterdayDateStr+".csv");
        try {
    ...
    public static void main(String[] args) {
        ...
        productDTO.setProductUrl("http://www.selfridges.com/GB/en/cat/veja-v-10-bastille-leather-trainers_923-10004-2088712109/?previewAttribute=White+navy");
        List<SkuDTO> zhiCaiSkuResultList = new ArrayList<>();
        SkuDTO skuDTO = new SkuDTO();
        //skuDTO.setSpSkuNo("30968589002");
        skuDTO.setSize("EUR 36");
        //skuDTO.setSupplierSkuNo("493117 X3I31 9169-U");
        skuDTO.setMarketPrice("340");
