...
import com.shangpin.iog.selfridgesOff.dto.ApiResponseBody;
import com.shangpin.iog.selfridgesOff.dto.SpSkuNoDTO;
import com.shangpin.iog.selfridgesOff.dto.ZhiCaiSkuHttpDTO;
import com.shangpin.iog.selfridgesOff.dto.ZhiCaiSkuStock;
...
public class UpdateStockImpl extends FetchStockImpl {
    ...
    public void fetchItlyProductStock(){
        ...
        System.out.println("============更新SelfridgesOff库存数据库开始 "+startDateTime+"=========================");
        logger.info("==============更新SelfridgesOff库存数据库开始 "+startDateTime+"=========================");
        ...
        String csvFilePath = filePath +"SelfridgesOff-qty-"+ yesterdayDateStr+".csv";
        ...
        logger.info("===================更新SelfridgesOff库存数据库结束 "+endtDateTime+"=========================");
        System.out.println("=================更新SelfridgesOff库存数据库结束 "+endtDateTime+"=========================");
        /*if (emailFlag==false){
            logger.info("===================准备发送邮件 =========================");
