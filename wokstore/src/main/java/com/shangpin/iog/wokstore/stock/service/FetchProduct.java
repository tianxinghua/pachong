package com.shangpin.iog.wokstore.stock.service;
...
import com.shangpin.iog.wokstore.stock.dto.*;
...
public class FetchProduct {
    ...
    String supplierId = "2015112001669";
    ...
    public void fetchProductAndSave() {
        ...
        String[]  databaseArray = new String[] {"wokstore"}; //
        for(String database:databaseArray){
            String season_json = HttpUtil45.get("http://net13server.net/wokapi/Myapi/Productslist/GetAllSeasonCode?DBContext="+database+"&key=c8jNh6cIRK",new OutTimeConfig(1000*60*2,1000*60*2,1000*60*2),null);
            ...
            for (Seasoncode obj : season_list.getSeasonCode()){
                ...
                while (true){
                    ...
                    producturl = "http://net13server.net/wokapi/Myapi/Productslist/GetProducts?DBContext="+database+"&CategoryId=&BrandId=&SeasonCode=[[seasoncode]]&StartIndex=[[startindex]]&EndIndex=[[endindex]]&key=c8jNh6cIRK";
                    String url = null;
                    try {
