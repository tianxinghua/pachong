package com.shangpin.ephub.data.mysql.picture.deleted.po;

import java.io.Serializable;
import java.util.Date;

public class HubSpuPendingPicDeleted implements Serializable {
    /**
     * 主键
     */
    ...
    public boolean equals(Object that) {
        ...
        HubSpuPendingPicDeleted other = (HubSpuPendingPicDeleted) that;
