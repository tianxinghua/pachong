package com.shangpin.ephub.data.mysql.product.supplier.po;
...
@Setter
@Getter
public class HubSupplierProduct extends HubSupplierSku {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -3417639444894623458L;
