...
public class HubSkuSupplierMappingController {
	...
	@RequestMapping(value = "/select-by-primary-key/{skuSupplierMappingId}")
    public HubSkuSupplierMapping selectByPrimaryKey(@PathVariable(value = "skuSupplierMappingId") Long skuSupplierMappingId){
