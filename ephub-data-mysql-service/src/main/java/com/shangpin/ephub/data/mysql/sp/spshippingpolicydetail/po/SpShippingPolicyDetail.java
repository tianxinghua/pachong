package com.shangpin.ephub.data.mysql.sp.spshippingpolicydetail.po;

import java.io.Serializable;
import java.util.Date;

public class SpShippingPolicyDetail implements Serializable {
    /**
     * 代理主键
     */
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        SpShippingPolicyDetail other = (SpShippingPolicyDetail) that;
