package com.shangpin.ephub.data.mysql.slot.fixedproperty.po;

import java.io.Serializable;
import java.util.Date;

public class HubSlotSpuFixedProperty implements Serializable {
    /**
     * 主键
     */
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        HubSlotSpuFixedProperty other = (HubSlotSpuFixedProperty) that;
