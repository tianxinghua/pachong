package com.shangpin.ephub.data.mysql.mapping.column.po;

import java.io.Serializable;
import java.util.Date;

public class HubSupplierColMapping implements Serializable {
    /**
     * 主键
     */
    ...
    public boolean equals(Object that) {
        ...
        HubSupplierColMapping other = (HubSupplierColMapping) that;
