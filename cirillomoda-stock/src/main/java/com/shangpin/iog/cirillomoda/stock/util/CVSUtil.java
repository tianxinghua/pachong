package com.shangpin.iog.cirillomoda.stock.util;
...
public class CVSUtil {
	 ...
	 * @throws Exception
	 */
	public static <T> List<T> readCSV(String result,Class<T> clazz, char sep)
			throws Exception {
		...
		CsvReader cr = null;
		// 解析csv文件
		cr = new CsvReader(new StringReader(result));
