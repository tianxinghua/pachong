...
public class Excel2DTO {
	...
	public static void main(String[] args) {
		String filePath = "E:\\20160126美峰供货尚品.xls";
		Integer sheetNum = 1;
		Short[] needColsNo = new Short[]{0,1,4,5};
		List<MeiFengSku> dto = new Excel2DTO().toDTO(filePath, sheetNum, needColsNo, MeiFengSku.class);
