...
public interface HubSkuSupplierMappingGateWay {
    ...
    public Long insert(@RequestBody HubSkuSupplierMappingDto hubSkuSupplierMapping);
	
	@RequestMapping(value = "/hub-sku-supplier-mapping/insert-selective", method = RequestMethod.POST,consumes = "application/json")
    public Long insertSelective(@RequestBody HubSkuSupplierMappingDto hubSkuSupplierMapping);
	...
	@RequestMapping(value = "/hub-sku-supplier-mapping/select-by-primary-key/{skuSupplierMappingId}", method = RequestMethod.POST,consumes = "application/json")
    public HubSkuSupplierMappingDto selectByPrimaryKey(@PathVariable("skuSupplierMappingId") Long skuSupplierMappingId);
