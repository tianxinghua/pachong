...
public interface HubSpuPendingPicGateWay {
    ...
    public Long insertSelective(@RequestBody HubSpuPendingPicDto hubSpuPendingPic);
	...
	@RequestMapping(value = "/hub-spu-pending-pic/select-by-primary-key/{spuPicId}", method = RequestMethod.GET,consumes = "application/json")
    public HubSpuPendingPicDto selectByPrimaryKey(@PathVariable("spuPicId") Long spuPicId);
