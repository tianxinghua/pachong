...
public class HubColorDicDto implements Serializable {
    /**
     * 主键
     */
    ...
    public boolean equals(Object that) {
        ...
        HubColorDicDto other = (HubColorDicDto) that;
        return (this.getColorDicId() == null ? other.getColorDicId() == null : this.getColorDicId().equals(other.getColorDicId()))
            && (this.getColorName() == null ? other.getColorName() == null : this.getColorName().equals(other.getColorName()))
            && (this.getColorNo() == null ? other.getColorNo() == null : this.getColorNo().equals(other.getColorNo()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getColorNo() == null) ? 0 : getColorNo().hashCode());
