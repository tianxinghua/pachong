...
public class TaskImportTemplate {
	 ...
	 public static String [] getPendingSpuTemplate(){
		 String[] headers = {"图片","供应商门户编号*","供应商编号", "供应商名称","供应商SpuNo", "供应商品类","品类名称","品类编号*", "品牌编号*","品牌名称","货号*","上市年份*","上市季节*","适应性别*",
				 "商品名称*","颜色*","材质*","产地*","描述","不符合项","商品状态","规格类型","库存总数","操作人"};
		 return headers;
	 }
	 public static String[] getPendingSpuValueTemplate() {
			String [] temp = {"spPicUrl","supplierId","supplierNo","supplierName","supplierSpuNo","supplierCategoryname","hubCategoryName","hubCategoryNo","hubBrandNo","hubBrandName","spuModel","seasonYear","seasonName","hubGender",
					"spuName","hubColor","hubMaterial","hubOrigin","spuDesc","memo","spuState","specificationType","totalStock","updateUser"};
			return temp;
		}
	 /**
	  * 全部商品页，商品导出模板
	 ...
	 public static String[] getProductAllTemplate(){
		 String[] headers = {"供应商门户编号*","供应商编号", "供应商名称","供应商SpuNo*", "品类名称","品类编号*", "品牌编号*","品牌名称","货号*","商品状态","上市年份*","上市季节*","适应性别*",
	 ...
	 public static String[] getProductAllValueTemplate() {
			String [] temp = {"supplierId","supplierNo","supplierName","supplierSpuNo","hubCategoryName","hubCategoryNo","hubBrandNo","hubBrandName","spuModel","spuState","seasonYear","seasonName","hubGender",
