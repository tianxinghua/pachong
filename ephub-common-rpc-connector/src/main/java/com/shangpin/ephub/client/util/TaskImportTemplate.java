...
public class TaskImportTemplate {
	 ...
	 public static String [] getPendingSkuTemplate(){
			String[] headers = { "供应商编号", "供应商名称", "品类名称","品类编号", "品牌编号*","品牌名称","货号*","上市年份*","上市季节*","适应性别*","供应商SkuNo*","商品名称*","条形码*",
	 ...
	 public static String [] getPendingSpuTemplate(){
		 String[] headers = { "供应商编号", "供应商名称", "品类名称","品类编号", "品牌编号*","品牌名称","货号*","上市年份*","上市季节*","适应性别*","商品名称*",
