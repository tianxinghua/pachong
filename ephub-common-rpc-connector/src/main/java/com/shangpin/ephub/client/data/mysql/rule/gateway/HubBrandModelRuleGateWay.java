...
public interface HubBrandModelRuleGateWay {
	...
	@RequestMapping(value = "/hub-brand-model-rule/delete-by-primary-key/{brandModelRuleId}", method = RequestMethod.POST,consumes = "application/json")
	...
	@RequestMapping(value = "/hub-brand-model-rule/select-by-primary-key/{brandModelRuleId}", method = RequestMethod.POST,consumes = "application/json")
    public HubBrandModelRuleDto selectByPrimaryKey(@PathVariable("brandModelRuleId") Long brandModelRuleId);
