...
import com.shangpin.ephub.client.data.mysql.studio.dto.HubPendingProductsDto;
...
public interface HubStudioGateWay {

    @RequestMapping(value = "/studio/get-pending-product-list", method = RequestMethod.POST,consumes = "application/json")
    public List<HubPendingProductsDto> getPendingProductList(@RequestBody StudioQueryDto queryDto);
}
