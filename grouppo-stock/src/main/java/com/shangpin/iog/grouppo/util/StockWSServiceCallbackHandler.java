...
public abstract class StockWSServiceCallbackHandler {
    ...
    public void receiveResultstock_Query(
        com.shangpin.iog.grouppo.util.StockWSServiceStub.Stock_QueryResponse result) {
    }
    ...
    public void receiveResultstock_TabularQuery(
        com.shangpin.iog.grouppo.util.StockWSServiceStub.Stock_TabularQueryResponse result) {
    }
