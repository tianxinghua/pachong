...
public class HttpUtils
{
  ...
  private static final Integer SO_TIMEOUT = Integer.valueOf(300000);
  ...
  public static HttpResponse get(String uri, Header[] headers, String encoding) throws Exception {
    ...
    httpclient.getHttpConnectionManager().getParams().setSoTimeout(SO_TIMEOUT.intValue());
    httpclient.getHttpConnectionManager().getParams().setConnectionTimeout(CONNECTION_TIMEOUT.intValue());
    try {
  ...
  public static HttpResponse post(String uri, NameValuePair[] data, Header[] headers) throws Exception
  {
    return post(uri, data, null, headers, null);
  }

  public static HttpResponse post(String uri, NameValuePair[] data, Map<String, String> map, Header[] headers, String encoding) throws Exception
  {
    HttpResponse httpResponse = new HttpResponse();
  ...
  public static HttpResponse post(String uri, Part[] parts, Header[] headers, String encoding) throws Exception
  {
    HttpResponse httpResponse = new HttpResponse();
  ...
  public static HttpResponse postString(String uri, String content, String contentType, Header[] headers, String encoding) throws Exception
  {
    HttpResponse httpResponse = new HttpResponse();
