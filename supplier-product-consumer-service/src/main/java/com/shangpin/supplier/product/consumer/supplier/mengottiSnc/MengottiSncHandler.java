package com.shangpin.supplier.product.consumer.supplier.mengottiSnc;
...
@Component("MengottiSncHandler")
@Slf4j
public class MengottiSncHandler implements ISupplierHandler {
