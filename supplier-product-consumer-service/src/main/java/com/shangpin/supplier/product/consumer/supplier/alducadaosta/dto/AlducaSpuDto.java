package com.shangpin.supplier.product.consumer.supplier.alducadaosta.dto;
...
@Getter
@Setter
public class AlducaSpuDto implements Serializable{
	...
	private List<AlducaSkuDto> skus;
