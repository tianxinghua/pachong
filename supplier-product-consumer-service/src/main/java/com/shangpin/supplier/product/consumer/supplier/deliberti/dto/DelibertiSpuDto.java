package com.shangpin.supplier.product.consumer.supplier.deliberti.dto;
...
@Getter
@Setter
public class DelibertiSpuDto implements Serializable{
	...
	private List<DelibertiSkuDto> skus;
