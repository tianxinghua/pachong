...
public class OriginalProductStreamListener {
	 ...
	 * @param headers 消息头
	 */
	@StreamListener(OriginalProductSink.FORZIERI)
	public void forzieriStreamListen(@Payload SupplierProduct message, @Headers Map<String,Object> headers) {
		adapter.forzieriStreamListen(message,headers);
	}
	/**
   ...
   public void parisiStreamListen(@Payload SupplierProduct message, @Headers Map<String,Object> headers) throws Exception  {
	 ...
	 * @param headers 消息头
	 */
	@StreamListener(OriginalProductSink.ACCURATIME)
	public void accuratimeStreamListen(@Payload SupplierProduct message, @Headers Map<String,Object> headers){
		adapter.accuratimeStreamListen(message,headers);
	}
}
