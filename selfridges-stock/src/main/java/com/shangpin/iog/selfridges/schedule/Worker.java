package com.shangpin.iog.selfridges.schedule;

import com.shangpin.iog.selfridges.service.FetchStockImpl;
...
public class Worker implements Runnable{
	...
	public void run() {
		try {
            ...
            System.out.println("selfridges库存数据库开始 "+startDateTime);
