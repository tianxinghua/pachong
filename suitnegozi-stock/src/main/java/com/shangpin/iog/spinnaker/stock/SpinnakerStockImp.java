...
public class SpinnakerStockImp extends AbsUpdateProductStock {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //loadSpringContext();
        //拉取数据
       // SpinnakerStockImp impl =(SpinnakerStockImp)factory.getBean("spinnaker");
        SpinnakerStockImp impl = new SpinnakerStockImp();
        List<String> skuNo = new ArrayList<>();
        skuNo.add("1000846000020");
        skuNo.add("1000846100055");
        skuNo.add("1000846000044");
        skuNo.add("1000846000087");
        //skuNo.add("fz580415-005-00");
        skuNo.add("1000823800018");
