...
public class UpdateStockImpl extends FetchStockImpl {
    ...
    public void fetchItlyProductStock(){
        ...
        String csvFilePath = filePath +"lkbennett-qty-"+ todayDateStr+"-2.csv";
        if(!new File(csvFilePath).exists()){
            csvFilePath = filePath +"lkbennett-qty-"+ todayDateStr+"-1.csv";
            if(!new File(csvFilePath).exists()){
                csvFilePath = filePath +"lkbennett-qty-"+ yesterdayDateStr+"-2.csv";
                if(!new File(csvFilePath).exists()){
                    csvFilePath = filePath +"lkbennett-qty-"+ yesterdayDateStr+"-1.csv";
                }
            }
        }
