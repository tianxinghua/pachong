...
public class ReconciliationFtpUtil {
	...
	// Locale.ENGLISH) ;
	private static String HOST = "114.142.223.126", PORT = "21",
			USER = "qbcftp", PASSWORD = "QBC1@1@Ftp", FILE_PATH = "/Output";
	...
	// ResourceBundle.getBundle(PROPERTIES_FILE_NAME) ;
	...
	public static <T> List<T> readLocalCSV(Class<T> clazz) throws Exception {
		...
		List<String> realPaths = download();
