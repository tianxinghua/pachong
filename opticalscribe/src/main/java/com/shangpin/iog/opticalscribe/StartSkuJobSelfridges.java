...
import com.shangpin.iog.opticalscribe.service.*;
 ...
 */
public class StartSkuJobSelfridges {
    ...
    public static void main(String[] args){
       ...
       // GucciProductIT fetchProduct =(GucciProductIT)factory.getBean("gucciProductIT");
        SelfridgesFR2 selfridgesFR=(SelfridgesFR2)factory.getBean("selfridgesFR2");
        try {
            selfridgesFR.getUrlList();
		} catch (Exception e) {
			e.printStackTrace();
		}
