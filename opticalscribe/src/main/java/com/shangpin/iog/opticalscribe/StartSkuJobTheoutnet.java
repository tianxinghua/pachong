...
import com.shangpin.iog.opticalscribe.service.TheoutnetFR;
 ...
 */
public class StartSkuJobTheoutnet {
    ...
    public static void main(String[] args){
       ...
       // GucciProductIT fetchProduct =(GucciProductIT)factory.getBean("gucciProductIT");
        TheoutnetFR theoutnetFR=(TheoutnetFR)factory.getBean("theoutnetFR");
        try {
            theoutnetFR.getUrlList();
		} catch (Exception e) {
			e.printStackTrace();
		}
