...
public class Item {
    ...
    public String getFarfetchId() {
        return farfetchId;
    }

    public void setFarfetchId(String farfetchId) {
        this.farfetchId = farfetchId;
    }
